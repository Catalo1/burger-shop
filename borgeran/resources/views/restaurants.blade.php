...
<head>
    ...
    <title>Borgeran - Restaurants</title>
            ...
            <div class="nav-wrapper">
                ...
                <nav class="nav-menu">
                    <ul>
                        ...
                        <li><a href="{{ url('restaurants') }}" class="nav-link active">Restaurants</a></li>
        ...
        <div class="container">
            ...
            <div class="restaurant-card">
                <div class="restaurant-image">
                    <img src="{{ asset('images/restaurant-exterior.png') }}" alt="Borgeran Restaurant">
                </div>
                <div class="restaurant-info">
                    <div class="restaurant-details">
                        <h2>Our stores are open for dine-in, take-out, drive-thru, and delivery Monday through Sunday, however operating hours may vary per location.</h2>
            ...
            <div class="location-section">
                <h2 class="location-title">Burgos Branch</h2>
                <div class="location-details">
                    <div class="address">
                        <strong>144 Burgos St, Downtown, Tacloban City, 6500 Leyte</strong>
                    </div>
                    
                    <div class="contact-info">
                        <p><strong>Mobile:</strong> (053)5039838(6)</p>
                        <p><strong>Landline:</strong> (053)8085-2268 / (053)8085-2278</p>
                    </div>
                    ...
                    <div class="delivery-partners">
                        <img src="{{ asset('images/foodpanda-logo.png') }}" alt="Foodpanda" class="partner-logo">
                    </div>
                </div>
            </div>
        </div>
