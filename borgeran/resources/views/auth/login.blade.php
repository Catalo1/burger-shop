...
<body class="login-page">
    <div class="auth-container">
        <div class="auth-left">
            <div style="margin-bottom: 18px; text-align: left; width: 100%;">
                <a href="/" class="back-home-link">
                    <span style="font-size: 1.2em; vertical-align: middle; color: #ff9a00;">←</span>
                    <span style="font-weight: 600; color: #ff9a00;">Back to Home</span>
                </a>
            </div>
            <div class="auth-logo">
